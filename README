...
Based on our initial vulnerability scan and assessment, we have prepared remediation commands and scripts to help you ease the initial remediation efforts. These can be integrated into your deployment platform (e.g., SCCM). Please test them before deploying to production.
...
Or view/download the script manually here: [wireshark-winpcap-force-remove.ps1](https://github.com/ngolesueh/Automation/blob/main/wireshark-winpcap-force-remove.ps1)
